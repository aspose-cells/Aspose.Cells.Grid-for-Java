...
<script type="text/javascript">
 ...
 {    //the default stype part for  gridweb component  is Stylemycomponent
	...
	$(document).ready(function(){
		...
		var method = {id:"loadChartFileSubmit"};
		doClick(method);
	});
</script>
</head>
<body>
	<div>
		<p>
            ...
            User can also call method to refresh all the chart image during some event.Check <a href="chartsubmit.jsp">here</a> for another demo. 
	...
	<div>
		<table>
			<tr>
				<th>Reload Data:</th>
				<td><input id="loadChartFileSubmit" type="button" value="Reload" onClick="doClick(this);"></td>
			</tr>
		</table>
	</div>
